...
exports.onRequest = function(res, method, pathname, cb){
...
function register(method, pathname, params, cb) {
	...
	if (params.name == null && params.category == null && params.price == null && params.description && null){
		...
		response.errormessage = "Invalid Parmeters";
		cb(response);
	} else {
		var connection = mysql.createConnection(conn);
		connection.connect();
		connection.query("insert into goods(nmae, category, price, description) values(?, ?, ?, ?)"
